import{o as Wc}from"./vendor-BXWtuYvb.js";const Hc=()=>{};var er={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p=function(n,e){if(!n)throw dt(e)},dt=function(n){return new Error("Firebase Database ("+lo.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qc(n){return fo(void 0,n)}function fo(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!$c(t)||(n[t]=fo(n[t],e[t]));return n}function $c(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jc=()=>zc().__FIREBASE_DEFAULTS__,Kc=()=>{if(typeof process>"u"||typeof er>"u")return;const n=er.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Yc=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&wn(n[1]);return e&&JSON.parse(e)},Zi=()=>{try{return Hc()||jc()||Kc()||Yc()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},po=n=>{var e,t;return(t=(e=Zi())==null?void 0:e.emulatorHosts)==null?void 0:t[n]},Qc=n=>{const e=po(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const i=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),i]:[e.substring(0,t),i]},_o=()=>{var n;return(n=Zi())==null?void 0:n.config},mo=n=>{var e;return(e=Zi())==null?void 0:e[`_${n}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ft(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function go(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function es(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(z())}function el(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function tl(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function yo(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function nl(){const n=z();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function il(){return lo.NODE_ADMIN===!0}function sl(){try{return typeof indexedDB=="object"}catch{return!1}}function rl(){return new Promise((n,e)=>{try{let t=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(i),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{var r;e(((r=s.error)==null?void 0:r.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ol="FirebaseError";class Le extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=ol,Object.setPrototypeOf(this,Le.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,tn.prototype.create)}}class tn{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?al(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Le(s,a,i)}}function al(n,e){return n.replace(cl,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const cl=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eo=function(n){let e={},t={},i={},s="";try{const r=n.split(".");e=Wt(wn(r[0])||""),t=Wt(wn(r[1])||""),s=r[2],i=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:i,signature:s}},ll=function(n){const e=Eo(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},ul=function(n){const e=Eo(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var C;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(C||(C={}));const El={debug:C.DEBUG,verbose:C.VERBOSE,info:C.INFO,warn:C.WARN,error:C.ERROR,silent:C.SILENT},vl=C.INFO,Tl={[C.DEBUG]:"log",[C.VERBOSE]:"log",[C.INFO]:"info",[C.WARN]:"warn",[C.ERROR]:"error"},wl=(n,e,...t)=>{if(e<n.logLevel)return;const i=new Date().toISOString(),s=Tl[e];if(s)console[s](`[${i}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ts{constructor(e){this.name=e,this._logLevel=vl,this._logHandler=wl,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in C))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?El[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,C.DEBUG,...e),this._logHandler(this,C.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,C.VERBOSE,...e),this._logHandler(this,C.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,C.INFO,...e),this._logHandler(this,C.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,C.WARN,...e),this._logHandler(this,C.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,C.ERROR,...e),this._logHandler(this,C.ERROR,...e)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cl{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Sl(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function Sl(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Oi="@firebase/app",ir="0.14.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me=new ts("@firebase/app"),bl="@firebase/app-compat",Rl="@firebase/analytics-compat",Al="@firebase/analytics",Nl="@firebase/app-check-compat",kl="@firebase/app-check",Pl="@firebase/auth",Ol="@firebase/auth-compat",Dl="@firebase/database",Ll="@firebase/data-connect",Ml="@firebase/database-compat",xl="@firebase/functions",Fl="@firebase/functions-compat",Ul="@firebase/installations",Vl="@firebase/installations-compat",Wl="@firebase/messaging",Hl="@firebase/messaging-compat",Bl="@firebase/performance",Gl="@firebase/performance-compat",ql="@firebase/remote-config",$l="@firebase/remote-config-compat",zl="@firebase/storage",jl="@firebase/storage-compat",Kl="@firebase/firestore",Yl="@firebase/ai",Ql="@firebase/firestore-compat",Jl="firebase",Xl="12.8.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Di="[DEFAULT]",Zl={[Oi]:"fire-core",[bl]:"fire-core-compat",[Al]:"fire-analytics",[Rl]:"fire-analytics-compat",[kl]:"fire-app-check",[Nl]:"fire-app-check-compat",[Pl]:"fire-auth",[Ol]:"fire-auth-compat",[Dl]:"fire-rtdb",[Ll]:"fire-data-connect",[Ml]:"fire-rtdb-compat",[xl]:"fire-fn",[Fl]:"fire-fn-compat",[Ul]:"fire-iid",[Vl]:"fire-iid-compat",[Wl]:"fire-fcm",[Hl]:"fire-fcm-compat",[Bl]:"fire-perf",[Gl]:"fire-perf-compat",[ql]:"fire-rc",[$l]:"fire-rc-compat",[zl]:"fire-gcs",[jl]:"fire-gcs-compat",[Kl]:"fire-fst",[Ql]:"fire-fst-compat",[Yl]:"fire-vertex","fire-js":"fire-js",[Jl]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pt=Xl;function iu(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i={name:Di,automaticDataCollectionEnabled:!0,...e},s=i.name;if(typeof s!="string"||!s)throw Se.create("bad-app-name",{appName:String(s)});if(t||(t=_o()),!t)throw Se.create("no-options");const r=Sn.get(s);if(r){if(Be(t,r.options)&&Be(i,r.config))return r;throw Se.create("duplicate-app",{appName:s})}const o=new yl(s);for(const c of Li.values())o.addComponent(c);const a=new nu(t,i,o);return Sn.set(s,a),a}function vo(n=Di){const e=Sn.get(n);if(!e&&n===Di&&_o())return iu();if(!e)throw Se.create("no-app",{appName:n});return e}function be(n,e,t){let i=Zl[n]??n;t&&(i+=`-${t}`);const s=i.match(/\s|\//),r=e.match(/\s|\//);if(s||r){const o=[`Unable to register library "${i}" with version "${e}":`];s&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),me.warn(o.join(" "));return}rt(new Ge(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const su="firebase-heartbeat-database",ru=1,Ht="firebase-heartbeat-store";let mi=null;function To(){return mi||(mi=Wc(su,ru,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ht)}catch(t){console.warn(t)}}}}).catch(n=>{throw Se.create("idb-open",{originalErrorMessage:n.message})})),mi}async function ou(n){try{const t=(await To()).transaction(Ht),i=await t.objectStore(Ht).get(wo(n));return await t.done,i}catch(e){if(e instanceof Le)me.warn(e.message);else{const t=Se.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});me.warn(t.message)}}}async function rr(n,e){try{const i=(await To()).transaction(Ht,"readwrite");await i.objectStore(Ht).put(e,wo(n)),await i.done}catch(t){if(t instanceof Le)me.warn(t.message);else{const i=Se.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});me.warn(i.message)}}}function wo(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const au=1024,cu=30;class lu{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new hu(t),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){var e,t;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=or();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(o=>o.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:s}),this._heartbeatsCache.heartbeats.length>cu){const o=du(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(i){me.warn(i)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=or(),{heartbeatsToSend:i,unsentEntries:s}=uu(this._heartbeatsCache.heartbeats),r=Tn(JSON.stringify({version:2,heartbeats:i}));return this._heartbeatsCache.lastSentHeartbeatDate=t,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(t){return me.warn(t),""}}}function or(){return new Date().toISOString().substring(0,10)}function uu(n,e=au){const t=[];let i=n.slice();for(const s of n){const r=t.find(o=>o.agent===s.agent);if(r){if(r.dates.push(s.date),ar(t)>e){r.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),ar(t)>e){t.pop();break}i=i.slice(1)}return{heartbeatsToSend:t,unsentEntries:i}}class hu{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return sl()?rl().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await ou(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return rr(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return rr(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function ar(n){return Tn(JSON.stringify({version:2,heartbeats:n})).length}function du(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let i=1;i<n.length;i++)n[i].date<t&&(t=n[i].date,e=i);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fu(n){rt(new Ge("platform-logger",e=>new Cl(e),"PRIVATE")),rt(new Ge("heartbeat",e=>new lu(e),"PRIVATE")),be(Oi,ir,n),be(Oi,ir,"esm2020"),be("fire-js","")}fu("");var pu="firebase",_u="12.8.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */be(pu,_u,"app");var cr={};const lr="@firebase/database",ur="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return oe(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new gu(e)}}catch{}return new Iu},Ve=So("localStorage"),yu=So("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ze=new ts("@firebase/database"),Eu=(function(){let n=1;return function(){return n++}})(),bo=function(n){const e=_l(n),t=new hl;t.update(e);const i=t.digest();return Xi.encodeByteArray(i)},nn=function(...n){let e="";for(let t=0;t<n.length;t++){const i=n[t];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=nn.apply(null,i):typeof i=="object"?e+=F(i):e+=i,e+=" "}return e};let Pt=null,hr=!0;const vu=function(n,e){p(!0,"Can't turn on custom loggers persistently."),Ze.logLevel=C.VERBOSE,Pt=Ze.log.bind(Ze)},H=function(...n){if(hr===!0&&(hr=!1,Pt===null&&yu.get("logging_enabled")===!0&&vu()),Pt){const e=nn.apply(null,n);Pt(e)}},sn=function(n){return function(...e){H(n,...e)}},Mi=function(...n){const e="FIREBASE INTERNAL ERROR: "+nn(...n);Ze.error(e)},ge=function(...n){const e=`FIREBASE FATAL ERROR: ${nn(...n)}`;throw Ze.error(e),new Error(e)},q=function(...n){const e="FIREBASE WARNING: "+nn(...n);Ze.warn(e)},Tu=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&q("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},is=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},wu=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},ot="[MIN_NAME]",qe="[MAX_NAME]",Ke=function(n,e){if(n===e)return 0;if(n===ot||e===qe)return-1;if(e===ot||n===qe)return 1;{const t=dr(n),i=dr(e);return t!==null?i!==null?t-i===0?n.length-e.length:t-i:-1:i!==null?1:n<e?-1:1}},Cu=function(n,e){return n===e?0:n<e?-1:1},Tt=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+F(e))},ss=function(n){if(typeof n!="object"||n===null)return F(n);const e=[];for(const i in n)e.push(i);e.sort();let t="{";for(let i=0;i<e.length;i++)i!==0&&(t+=","),t+=F(e[i]),t+=":",t+=ss(n[e[i]]);return t+="}",t},Ro=function(n,e){const t=n.length;if(t<=e)return[n];const i=[];for(let s=0;s<t;s+=e)s+e>t?i.push(n.substring(s,t)):i.push(n.substring(s,s+e));return i};function B(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const Ao=function(n){p(!is(n),"Invalid JSON number");const e=11,t=52,i=(1<<e-1)-1;let s,r,o,a,c;n===0?(r=0,o=0,s=1/n===-1/0?1:0):(s=n<0,n=Math.abs(n),n>=Math.pow(2,1-i)?(a=Math.min(Math.floor(Math.log(n)/Math.LN2),i),r=a+i,o=Math.round(n*Math.pow(2,t-a)-Math.pow(2,t))):(r=0,o=Math.round(n/Math.pow(2,1-i-t))));const l=[];for(c=t;c;c-=1)l.push(o%2?1:0),o=Math.floor(o/2);for(c=e;c;c-=1)l.push(r%2?1:0),r=Math.floor(r/2);l.push(s?1:0),l.reverse();const h=l.join("");let u="";for(c=0;c<64;c+=8){let d=parseInt(h.substr(c,8),2).toString(16);d.length===1&&(d="0"+d),u=u+d}return u.toLowerCase()},Su=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},bu=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function Ru(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const i=new Error(n+" at "+e._path.toString()+": "+t);return i.code=n.toUpperCase(),i}const Au=new RegExp("^-?(0*)\\d{1,10}$"),Nu=-2147483648,ku=2147483647,dr=function(n){if(Au.test(n)){const e=Number(n);if(e>=Nu&&e<=ku)return e}return null},_t=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw q("Exception was thrown by user callback.",t),e},Math.floor(0))}},Pu=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Ot=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,k(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(i=>this.appCheck=i)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(i=>i.addTokenListener(e))}notifyForInvalidToken(){q(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Du{constructor(e,t,i){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=i,this.auth_=null,this.auth_=i.getImmediate({optional:!0}),this.auth_||i.onInit(s=>this.auth_=s)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(H("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,i)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',q(e)}}class gn{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}gn.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rs="5",No="v",ko="s",Po="r",Oo="f",Do=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Lo="ls",Mo="p",xi="ac",xo="websocket",Fo="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mu{constructor(){this.counters_={}}incrementCounter(e,t=1){oe(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return qc(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gi={},Ii={};function os(n){const e=n.toString();return gi[e]||(gi[e]=new Mu),gi[e]}function xu(n,e){const t=n.toString();return Ii[t]||(Ii[t]=e()),Ii[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fu{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&_t(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr="start",Uu="close",Vu="pLPCommand",Wu="pRTLPCB",Wo="id",Ho="pw",Bo="ser",Hu="cb",Bu="seg",Gu="ts",qu="d",$u="dframe",Go=1870,qo=30,zu=Go-qo,ju=25e3,Ku=3e4;class Xe{constructor(e,t,i,s,r,o,a){this.connId=e,this.repoInfo=t,this.applicationId=i,this.appCheckToken=s,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=sn(e),this.stats_=os(t),this.urlFn=c=>(this.appCheckToken&&(c[xi]=this.appCheckToken),Vo(t,Fo,c))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new Fu(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Ku)),wu(()=>{if(this.isClosed_)return;this.scriptTagHolder=new as((...r)=>{const[o,a,c,l,h]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===fr)this.id=a,this.password=c;else if(o===Uu)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const i={};i[fr]="t",i[Bo]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(i[Hu]=this.scriptTagHolder.uniqueCallbackIdentifier),i[No]=rs,this.transportSessionId&&(i[ko]=this.transportSessionId),this.lastSessionId&&(i[Lo]=this.lastSessionId),this.applicationId&&(i[Mo]=this.applicationId),this.appCheckToken&&(i[xi]=this.appCheckToken),typeof location<"u"&&location.hostname&&Do.test(location.hostname)&&(i[Po]=Oo);const s=this.urlFn(i);this.log_("Connecting via long-poll to "+s),this.scriptTagHolder.addTag(s,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){Xe.forceAllow_=!0}static forceDisallow(){Xe.forceDisallow_=!0}static isAvailable(){return Xe.forceAllow_?!0:!Xe.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!Su()&&!bu()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=F(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const i=ho(t),s=Ro(i,zu);for(let r=0;r<s.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,s.length,s[r]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const i={};i[$u]="t",i[Wo]=e,i[Ho]=t,this.myDisconnFrame.src=this.urlFn(i),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=F(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class as{constructor(e,t,i,s){this.onDisconnect=i,this.urlFn=s,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=Eu(),window[Vu+this.uniqueCallbackIdentifier]=e,window[Wu+this.uniqueCallbackIdentifier]=t,this.myIFrame=as.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){H("frame writing exception"),a.stack&&H(a.stack),H(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||H("No IE domain setting required")}catch{const i=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+i+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Wo]=this.myID,e[Ho]=this.myPW,e[Bo]=this.currentSerial;let t=this.urlFn(e),i="",s=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+qo+i.length<=Go;){const o=this.pendingSegs.shift();i=i+"&"+Bu+s+"="+o.seg+"&"+Gu+s+"="+o.ts+"&"+qu+s+"="+o.d,s++}return t=t+i,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,i){this.pendingSegs.push({seg:e,ts:t,d:i}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const i=()=>{this.outstandingRequests.delete(t),this.newRequest_()},s=setTimeout(i,Math.floor(ju)),r=()=>{clearTimeout(s),i()};this.addTag(e,r)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const i=this.myIFrame.doc.createElement("script");i.type="text/javascript",i.async=!0,i.src=e,i.onload=i.onreadystatechange=function(){const s=i.readyState;(!s||s==="loaded"||s==="complete")&&(i.onload=i.onreadystatechange=null,i.parentNode&&i.parentNode.removeChild(i),t())},i.onerror=()=>{H("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(i)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zo{constructor(e){this.allowedEvents_=e,this.listeners_={},p(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...t){if(Array.isArray(this.listeners_[e])){const i=[...this.listeners_[e]];for(let s=0;s<i.length;s++)i[s].callback.apply(i[s].context,t)}}on(e,t,i){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:i});const s=this.getInitialEvent(e);s&&t.apply(i,s)}off(e,t,i){this.validateEventType_(e);const s=this.listeners_[e]||[];for(let r=0;r<s.length;r++)if(s[r].callback===t&&(!i||i===s[r].context)){s.splice(r,1);return}}validateEventType_(e){p(this.allowedEvents_.find(t=>t===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Er=32,vr=768;class S{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function w(){return new S("")}function y(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function Pe(n){return n.pieces_.length-n.pieceNum_}function R(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new S(n.pieces_,e)}function cs(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function rh(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function Gt(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function jo(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new S(e,0)}function P(n,e){const t=[];for(let i=n.pieceNum_;i<n.pieces_.length;i++)t.push(n.pieces_[i]);if(e instanceof S)for(let i=e.pieceNum_;i<e.pieces_.length;i++)t.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&t.push(i[s])}return new S(t,0)}function v(n){return n.pieceNum_>=n.pieces_.length}function G(n,e){const t=y(n),i=y(e);if(t===null)return e;if(t===i)return G(R(n),R(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function oh(n,e){const t=Gt(n,0),i=Gt(e,0);for(let s=0;s<t.length&&s<i.length;s++){const r=Ke(t[s],i[s]);if(r!==0)return r}return t.length===i.length?0:t.length<i.length?-1:1}function ls(n,e){if(Pe(n)!==Pe(e))return!1;for(let t=n.pieceNum_,i=e.pieceNum_;t<=n.pieces_.length;t++,i++)if(n.pieces_[t]!==e.pieces_[i])return!1;return!0}function Q(n,e){let t=n.pieceNum_,i=e.pieceNum_;if(Pe(n)>Pe(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[i])return!1;++t,++i}return!0}class ah{constructor(e,t){this.errorPrefix_=t,this.parts_=Gt(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=zn(this.parts_[i]);Ko(this)}}function ch(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=zn(e),Ko(n)}function lh(n){const e=n.parts_.pop();n.byteLength_-=zn(e),n.parts_.length>0&&(n.byteLength_-=1)}function Ko(n){if(n.byteLength_>vr)throw new Error(n.errorPrefix_+"has a key path longer than "+vr+" bytes ("+n.byteLength_+").");if(n.parts_.length>Er)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Er+") or object contains a cycle "+Ue(n))}function Ue(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class us extends zo{static getInstance(){return new us}constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const i=!document[e];i!==this.visible_&&(this.visible_=i,this.trigger("visible",i))},!1)}getInitialEvent(e){return p(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let fn;class Yo extends jn{static get __EMPTY_NODE(){return fn}static set __EMPTY_NODE(e){fn=e}compare(e,t){return Ke(e.name,t.name)}isDefinedOn(e){throw dt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return E.MIN}maxPost(){return new E(qe,fn)}makePost(e,t){return p(typeof e=="string","KeyIndex indexValue must always be a string."),new E(e,fn)}toString(){return".key"}}const et=new Yo;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _h(n,e){return Ke(n.name,e.name)}function hs(n,e){return Ke(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fi;function mh(n){Fi=n}const Qo=function(n){return typeof n=="number"?"number:"+Ao(n):"string:"+n},Jo=function(n){if(n.isLeafNode()){const e=n.val();p(typeof e=="string"||typeof e=="number"||typeof e=="object"&&oe(e,".sv"),"Priority must be a string or number.")}else p(n===Fi||n.isEmpty(),"priority of unexpected type.");p(n===Fi||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xo,Zo;function gh(n){Xo=n}function Ih(n){Zo=n}class yh extends jn{compare(e,t){const i=e.node.getPriority(),s=t.node.getPriority(),r=i.compareTo(s);return r===0?Ke(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return E.MIN}maxPost(){return new E(qe,new U("[PRIORITY-POST]",Zo))}makePost(e,t){const i=Xo(e);return new E(t,new U("[PRIORITY-POST]",i))}toString(){return".priority"}}const O=new yh;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wh=!0;function x(n,e=null){if(n===null)return g.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),p(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new U(t,x(e))}if(!(n instanceof Array)&&wh){const t=[];let i=!1;if(B(n,(o,a)=>{if(o.substring(0,1)!=="."){const c=x(a);c.isEmpty()||(i=i||!c.getPriority().isEmpty(),t.push(new E(o,c)))}}),t.length===0)return g.EMPTY_NODE;const r=An(t,_h,o=>o.name,hs);if(i){const o=An(t,O.getCompare());return new g(r,x(e),new he({".priority":o},{".priority":O}))}else return new g(r,x(e),he.Default)}else{let t=g.EMPTY_NODE;return B(n,(i,s)=>{if(oe(n,i)&&i.substring(0,1)!=="."){const r=x(s);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(i,r))}}),t.updatePriority(x(e))}}gh(x);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sh extends jn{compare(e,t){const i=e.node.compareTo(t.node);return i===0?Ke(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return E.MIN}maxPost(){return E.MAX}makePost(e,t){const i=x(e);return new E(t,i)}toString(){return".value"}}const bh=new Sh;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ea(n){return{type:"value",snapshotNode:n}}function at(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function qt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function $t(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Rh(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kn(){return{value:null,children:new Map}}function ta(n,e,t){if(v(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=y(e);n.children.has(i)||n.children.set(i,kn());const s=n.children.get(i);e=R(e),ta(s,e,t)}}function Ui(n,e,t){n.value!==null?t(e,n.value):Ph(n,(i,s)=>{const r=new S(e.toString()+"/"+i);Ui(s,r,t)})}function Ph(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oh{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&B(this.last_,(i,s)=>{t[i]=t[i]-s}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rr=10*1e3,Dh=30*1e3,Lh=300*1e3;class Mh{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Oh(e);const i=Rr+(Dh-Rr)*Math.random();Ot(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;B(e,(s,r)=>{r>0&&oe(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),Ot(this.reportStats_.bind(this),Math.floor(Math.random()*2*Lh))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xh{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Fh(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Rh(o.childName,o.snapshotNode))}),St(n,s,"child_removed",e,i,t),St(n,s,"child_added",e,i,t),St(n,s,"child_moved",r,i,t),St(n,s,"child_changed",e,i,t),St(n,s,"value",e,i,t),s}function St(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,c)=>Vh(n,a,c)),o.forEach(a=>{const c=Uh(n,a,r);s.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,n.query_))})})}function Uh(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Vh(n,e,t){if(e.childName==null||t.childName==null)throw dt("Should only compare child_ events.");const i=new E(e.childName,e.snapshotNode),s=new E(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kn(n,e){return{eventCache:n,serverCache:e}}function Dt(n,e,t,i){return Kn(new Oe(e,t,i),n.serverCache)}function na(n,e,t,i){return Kn(n.eventCache,new Oe(e,t,i))}function On(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function ze(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yn(n,e){return aa(e,n)}function Hh(n,e,t,i,s){p(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=Lt(n.visibleWrites,e,t)),n.lastWriteId=i}function Bh(n,e,t,i){p(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=Vi(n.visibleWrites,e,t),n.lastWriteId=i}function Gh(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function qh(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);p(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&$h(a,i.path)?s=!1:Q(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return zh(n),!0;if(i.snap)n.visibleWrites=Ar(n.visibleWrites,i.path);else{const a=i.children;B(a,c=>{n.visibleWrites=Ar(n.visibleWrites,P(i.path,c))})}return!0}else return!1}function $h(n,e){if(n.snap)return Q(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Q(P(n.path,t),e))return!0;return!1}function zh(n){n.visibleWrites=sa(n.allWrites,jh,w()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function jh(n){return n.visible}function sa(n,e,t){let i=ie.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)Q(t,o)?(a=G(t,o),i=Lt(i,a,r.snap)):Q(o,t)&&(a=G(o,t),i=Lt(i,w(),r.snap.getChild(a)));else if(r.children){if(Q(t,o))a=G(t,o),i=Vi(i,a,r.children);else if(Q(o,t))if(a=G(o,t),v(a))i=Vi(i,w(),r.children);else{const c=st(r.children,y(a));if(c){const l=c.getChild(R(a));i=Lt(i,w(),l)}}}else throw dt("WriteRecord should have .snap or .children")}}return i}function ra(n,e,t,i,s){if(!i&&!s){const r=Ye(n.visibleWrites,e);if(r!=null)return r;{const o=Re(n.visibleWrites,e);if(Hi(o))return t;if(t==null&&!Wi(o,w()))return null;{const a=t||g.EMPTY_NODE;return lt(o,a)}}}else{const r=Re(n.visibleWrites,e);if(!s&&Hi(r))return t;if(!s&&t==null&&!Wi(r,w()))return null;{const o=function(l){return(l.visible||s)&&(!i||!~i.indexOf(l.writeId))&&(Q(l.path,e)||Q(e,l.path))},a=sa(n.allWrites,o,e),c=t||g.EMPTY_NODE;return lt(a,c)}}}function Kh(n,e,t){let i=g.EMPTY_NODE;const s=Ye(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(O,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=Re(n.visibleWrites,e);return t.forEachChild(O,(o,a)=>{const c=lt(Re(r,new S(o)),a);i=i.updateImmediateChild(o,c)}),Nr(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=Re(n.visibleWrites,e);return Nr(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Yh(n,e,t,i,s){p(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=P(e,t);if(Wi(n.visibleWrites,r))return null;{const o=Re(n.visibleWrites,r);return Hi(o)?s.getChild(t):lt(o,s.getChild(t))}}function Qh(n,e,t,i){const s=P(e,t),r=Ye(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=Re(n.visibleWrites,s);return lt(o,i.getNode().getImmediateChild(t))}else return null}function Jh(n,e){return Ye(n.visibleWrites,e)}function Xh(n,e,t,i,s,r,o){let a;const c=Re(n.visibleWrites,e),l=Ye(c,w());if(l!=null)a=l;else if(t!=null)a=lt(c,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const h=[],u=o.getCompare(),d=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let _=d.getNext();for(;_&&h.length<s;)u(_,i)!==0&&h.push(_),_=d.getNext();return h}else return[]}function Zh(){return{visibleWrites:ie.empty(),allWrites:[],lastWriteId:-1}}function Dn(n,e,t,i){return ra(n.writeTree,n.treePath,e,t,i)}function gs(n,e){return Kh(n.writeTree,n.treePath,e)}function kr(n,e,t,i){return Yh(n.writeTree,n.treePath,e,t,i)}function Ln(n,e){return Jh(n.writeTree,P(n.treePath,e))}function ed(n,e,t,i,s,r){return Xh(n.writeTree,n.treePath,e,t,i,s,r)}function Is(n,e,t){return Qh(n.writeTree,n.treePath,e,t)}function oa(n,e){return aa(P(n.treePath,e),n.writeTree)}function aa(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nd{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const ca=new nd;class ys{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new Oe(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Is(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:ze(this.viewCache_),r=ed(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function id(n){return{filter:n}}function sd(n,e){p(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),p(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function rd(n,e,t,i,s){const r=new td;let o,a;if(t.type===te.OVERWRITE){const l=t;l.source.fromUser?o=Bi(n,e,l.path,l.snap,i,s,r):(p(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered()&&!v(l.path),o=Mn(n,e,l.path,l.snap,i,s,a,r))}else if(t.type===te.MERGE){const l=t;l.source.fromUser?o=ad(n,e,l.path,l.children,i,s,r):(p(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered(),o=Gi(n,e,l.path,l.children,i,s,a,r))}else if(t.type===te.ACK_USER_WRITE){const l=t;l.revert?o=ud(n,e,l.path,i,s,r):o=cd(n,e,l.path,l.affectedTree,i,s,r)}else if(t.type===te.LISTEN_COMPLETE)o=ld(n,e,t.path,i,r);else throw dt("Unknown operation type: "+t.type);const c=r.getChanges();return od(e,o,c),{viewCache:o,changes:c}}function od(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=On(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(ea(On(e)))}}function la(n,e,t,i,s,r){const o=e.eventCache;if(Ln(i,t)!=null)return e;{let a,c;if(v(t))if(p(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const l=ze(e),h=l instanceof g?l:g.EMPTY_NODE,u=gs(i,h);a=n.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const l=Dn(i,ze(e));a=n.filter.updateFullNode(e.eventCache.getNode(),l,r)}else{const l=y(t);if(l===".priority"){p(Pe(t)===1,"Can't have a priority with additional path components");const h=o.getNode();c=e.serverCache.getNode();const u=kr(i,t,h,c);u!=null?a=n.filter.updatePriority(h,u):a=o.getNode()}else{const h=R(t);let u;if(o.isCompleteForChild(l)){c=e.serverCache.getNode();const d=kr(i,t,o.getNode(),c);d!=null?u=o.getNode().getImmediateChild(l).updateChild(h,d):u=o.getNode().getImmediateChild(l)}else u=Is(i,l,e.serverCache);u!=null?a=n.filter.updateChild(o.getNode(),l,u,h,s,r):a=o.getNode()}}return Dt(e,a,o.isFullyInitialized()||v(t),n.filter.filtersNodes())}}function Mn(n,e,t,i,s,r,o,a){const c=e.serverCache;let l;const h=o?n.filter:n.filter.getIndexedFilter();if(v(t))l=h.updateFullNode(c.getNode(),i,null);else if(h.filtersNodes()&&!c.isFiltered()){const _=c.getNode().updateChild(t,i);l=h.updateFullNode(c.getNode(),_,null)}else{const _=y(t);if(!c.isCompleteForPath(t)&&Pe(t)>1)return e;const m=R(t),L=c.getNode().getImmediateChild(_).updateChild(m,i);_===".priority"?l=h.updatePriority(c.getNode(),L):l=h.updateChild(c.getNode(),_,L,m,ca,null)}const u=na(e,l,c.isFullyInitialized()||v(t),h.filtersNodes()),d=new ys(s,u,r);return la(n,u,t,s,d,a)}function Bi(n,e,t,i,s,r,o){const a=e.eventCache;let c,l;const h=new ys(s,e,r);if(v(t))l=n.filter.updateFullNode(e.eventCache.getNode(),i,o),c=Dt(e,l,!0,n.filter.filtersNodes());else{const u=y(t);if(u===".priority")l=n.filter.updatePriority(e.eventCache.getNode(),i),c=Dt(e,l,a.isFullyInitialized(),a.isFiltered());else{const d=R(t),_=a.getNode().getImmediateChild(u);let m;if(v(d))m=i;else{const T=h.getCompleteChild(u);T!=null?cs(d)===".priority"&&T.getChild(jo(d)).isEmpty()?m=T:m=T.updateChild(d,i):m=g.EMPTY_NODE}if(_.equals(m))c=e;else{const T=n.filter.updateChild(a.getNode(),u,m,d,h,o);c=Dt(e,T,a.isFullyInitialized(),n.filter.filtersNodes())}}}return c}function Pr(n,e){return n.eventCache.isCompleteForChild(e)}function ad(n,e,t,i,s,r,o){let a=e;return i.foreach((c,l)=>{const h=P(t,c);Pr(e,y(h))&&(a=Bi(n,a,h,l,s,r,o))}),i.foreach((c,l)=>{const h=P(t,c);Pr(e,y(h))||(a=Bi(n,a,h,l,s,r,o))}),a}function Or(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Gi(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let c=e,l;v(t)?l=i:l=new b(null).setTree(t,i);const h=e.serverCache.getNode();return l.children.inorderTraversal((u,d)=>{if(h.hasChild(u)){const _=e.serverCache.getNode().getImmediateChild(u),m=Or(n,_,d);c=Mn(n,c,new S(u),m,s,r,o,a)}}),l.children.inorderTraversal((u,d)=>{const _=!e.serverCache.isCompleteForChild(u)&&d.value===null;if(!h.hasChild(u)&&!_){const m=e.serverCache.getNode().getImmediateChild(u),T=Or(n,m,d);c=Mn(n,c,new S(u),T,s,r,o,a)}}),c}function cd(n,e,t,i,s,r,o){if(Ln(s,t)!=null)return e;const a=e.serverCache.isFiltered(),c=e.serverCache;if(i.value!=null){if(v(t)&&c.isFullyInitialized()||c.isCompleteForPath(t))return Mn(n,e,t,c.getNode().getChild(t),s,r,a,o);if(v(t)){let l=new b(null);return c.getNode().forEachChild(et,(h,u)=>{l=l.set(new S(h),u)}),Gi(n,e,t,l,s,r,a,o)}else return e}else{let l=new b(null);return i.foreach((h,u)=>{const d=P(t,h);c.isCompleteForPath(d)&&(l=l.set(h,c.getNode().getChild(d)))}),Gi(n,e,t,l,s,r,a,o)}}function ld(n,e,t,i,s){const r=e.serverCache,o=na(e,r.getNode(),r.isFullyInitialized()||v(t),r.isFiltered());return la(n,o,t,i,ca,s)}function ud(n,e,t,i,s,r){let o;if(Ln(i,t)!=null)return e;{const a=new ys(i,e,s),c=e.eventCache.getNode();let l;if(v(t)||y(t)===".priority"){let h;if(e.serverCache.isFullyInitialized())h=Dn(i,ze(e));else{const u=e.serverCache.getNode();p(u instanceof g,"serverChildren would be complete if leaf node"),h=gs(i,u)}h=h,l=n.filter.updateFullNode(c,h,r)}else{const h=y(t);let u=Is(i,h,e.serverCache);u==null&&e.serverCache.isCompleteForChild(h)&&(u=c.getImmediateChild(h)),u!=null?l=n.filter.updateChild(c,h,u,R(t),a,r):e.eventCache.getNode().hasChild(h)?l=n.filter.updateChild(c,h,g.EMPTY_NODE,R(t),a,r):l=c,l.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Dn(i,ze(e)),o.isLeafNode()&&(l=n.filter.updateFullNode(l,o,r)))}return o=e.serverCache.isFullyInitialized()||Ln(i,w())!=null,Dt(e,l,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hd{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const i=this.query_._queryParams,s=new ds(i.getIndex()),r=Nh(i);this.processor_=id(r);const o=t.serverCache,a=t.eventCache,c=s.updateFullNode(g.EMPTY_NODE,o.getNode(),null),l=r.updateFullNode(g.EMPTY_NODE,a.getNode(),null),h=new Oe(c,o.isFullyInitialized(),s.filtersNodes()),u=new Oe(l,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=Kn(u,h),this.eventGenerator_=new xh(this.query_)}get query(){return this.query_}}function dd(n){return n.viewCache_.serverCache.getNode()}function fd(n){return On(n.viewCache_)}function pd(n,e){const t=ze(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!v(e)&&!t.getImmediateChild(y(e)).isEmpty())?t.getChild(e):null}function Dr(n){return n.eventRegistrations_.length===0}function _d(n,e){n.eventRegistrations_.push(e)}function Lr(n,e,t){const i=[];if(t){p(e==null,"A cancel should cancel all event registrations.");const s=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,s);o&&i.push(o)})}if(e){let s=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))s.push(o);else if(e.hasAnyCallback()){s=s.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=s}else n.eventRegistrations_=[];return i}function Mr(n,e,t,i){e.type===te.MERGE&&e.source.queryId!==null&&(p(ze(n.viewCache_),"We should always have a full cache before handling merges"),p(On(n.viewCache_),"Missing event cache, even though we have a server cache"));const s=n.viewCache_,r=rd(n.processor_,s,e,t,i);return sd(n.processor_,r.viewCache),p(r.viewCache.serverCache.isFullyInitialized()||!s.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,ua(n,r.changes,r.viewCache.eventCache.getNode(),null)}function md(n,e){const t=n.viewCache_.eventCache,i=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(O,(r,o)=>{i.push(at(r,o))}),t.isFullyInitialized()&&i.push(ea(t.getNode())),ua(n,i,t.getNode(),e)}function ua(n,e,t,i){const s=i?[i]:n.eventRegistrations_;return Fh(n.eventGenerator_,e,t,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xn;class ha{constructor(){this.views=new Map}}function gd(n){p(!xn,"__referenceConstructor has already been defined"),xn=n}function Id(){return p(xn,"Reference.ts has not been loaded"),xn}function yd(n){return n.views.size===0}function Es(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return p(r!=null,"SyncTree gave us an op for an invalid query."),Mr(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(Mr(o,e,t,i));return r}}function da(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Dn(t,s?i:null),c=!1;a?c=!0:i instanceof g?(a=gs(t,i),c=!1):(a=g.EMPTY_NODE,c=!1);const l=Kn(new Oe(a,c,!1),new Oe(i,s,!1));return new hd(e,l)}return o}function Ed(n,e,t,i,s,r){const o=da(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),_d(o,t),md(o,t)}function vd(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=De(n);if(s==="default")for(const[c,l]of n.views.entries())o=o.concat(Lr(l,t,i)),Dr(l)&&(n.views.delete(c),l.query._queryParams.loadsAllData()||r.push(l.query));else{const c=n.views.get(s);c&&(o=o.concat(Lr(c,t,i)),Dr(c)&&(n.views.delete(s),c.query._queryParams.loadsAllData()||r.push(c.query)))}return a&&!De(n)&&r.push(new(Id())(e._repo,e._path)),{removed:r,events:o}}function fa(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function Ae(n,e){let t=null;for(const i of n.views.values())t=t||pd(i,e);return t}function pa(n,e){if(e._queryParams.loadsAllData())return Qn(n);{const i=e._queryIdentifier;return n.views.get(i)}}function _a(n,e){return pa(n,e)!=null}function De(n){return Qn(n)!=null}function Qn(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fn;function Td(n){p(!Fn,"__referenceConstructor has already been defined"),Fn=n}function wd(){return p(Fn,"Reference.ts has not been loaded"),Fn}let Cd=1;class xr{constructor(e){this.listenProvider_=e,this.syncPointTree_=new b(null),this.pendingWriteTree_=Zh(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ma(n,e,t,i,s){return Hh(n.pendingWriteTree_,e,t,i,s),s?mt(n,new $e(ps(),e,t)):[]}function Sd(n,e,t,i){Bh(n.pendingWriteTree_,e,t,i);const s=b.fromObject(t);return mt(n,new ct(ps(),e,s))}function Ce(n,e,t=!1){const i=Gh(n.pendingWriteTree_,e);if(qh(n.pendingWriteTree_,e)){let r=new b(null);return i.snap!=null?r=r.set(w(),!0):B(i.children,o=>{r=r.set(new S(o),!0)}),mt(n,new Pn(i.path,r,t))}else return[]}function on(n,e,t){return mt(n,new $e(_s(),e,t))}function bd(n,e,t){const i=b.fromObject(t);return mt(n,new ct(_s(),e,i))}function Rd(n,e){return mt(n,new jt(_s(),e))}function Ad(n,e,t){const i=Ts(n,t);if(i){const s=ws(i),r=s.path,o=s.queryId,a=G(r,e),c=new jt(ms(o),a);return Cs(n,r,c)}else return[]}function Un(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||_a(o,e))){const c=vd(o,e,t,i);yd(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const l=c.removed;if(a=c.events,!s){const h=l.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(d,_)=>De(_));if(h&&!u){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=Pd(d);for(let m=0;m<_.length;++m){const T=_[m],L=T.query,Y=Ea(n,T);n.listenProvider_.startListening(Mt(L),Kt(n,L),Y.hashFn,Y.onComplete)}}}!u&&l.length>0&&!i&&(h?n.listenProvider_.stopListening(Mt(e),null):l.forEach(d=>{const _=n.queryToTagMap.get(Jn(d));n.listenProvider_.stopListening(Mt(d),_)}))}Od(n,l)}return a}function ga(n,e,t,i){const s=Ts(n,i);if(s!=null){const r=ws(s),o=r.path,a=r.queryId,c=G(o,e),l=new $e(ms(a),c,t);return Cs(n,o,l)}else return[]}function Nd(n,e,t,i){const s=Ts(n,i);if(s){const r=ws(s),o=r.path,a=r.queryId,c=G(o,e),l=b.fromObject(t),h=new ct(ms(a),c,l);return Cs(n,o,h)}else return[]}function qi(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(d,_)=>{const m=G(d,s);r=r||Ae(_,m),o=o||De(_)});let a=n.syncPointTree_.get(s);a?(o=o||De(a),r=r||Ae(a,w())):(a=new ha,n.syncPointTree_=n.syncPointTree_.set(s,a));let c;r!=null?c=!0:(c=!1,r=g.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((_,m)=>{const T=Ae(m,w());T&&(r=r.updateImmediateChild(_,T))}));const l=_a(a,e);if(!l&&!e._queryParams.loadsAllData()){const d=Jn(e);p(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=Dd();n.queryToTagMap.set(d,_),n.tagToQueryMap.set(_,d)}const h=Yn(n.pendingWriteTree_,s);let u=Ed(a,e,t,h,r,c);if(!l&&!o&&!i){const d=pa(a,e);u=u.concat(Ld(n,e,d))}return u}function vs(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const c=G(o,e),l=Ae(a,c);if(l)return l});return ra(s,e,r,t,!0)}function kd(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(l,h)=>{const u=G(l,t);i=i||Ae(h,u)});let s=n.syncPointTree_.get(t);s?i=i||Ae(s,w()):(s=new ha,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new Oe(i,!0,!1):null,a=Yn(n.pendingWriteTree_,e._path),c=da(s,e,a,r?o.getNode():g.EMPTY_NODE,r);return fd(c)}function mt(n,e){return Ia(e,n.syncPointTree_,null,Yn(n.pendingWriteTree_,w()))}function Ia(n,e,t,i){if(v(n.path))return ya(n,e,t,i);{const s=e.get(w());t==null&&s!=null&&(t=Ae(s,w()));let r=[];const o=y(n.path),a=n.operationForChild(o),c=e.children.get(o);if(c&&a){const l=t?t.getImmediateChild(o):null,h=oa(i,o);r=r.concat(Ia(a,c,l,h))}return s&&(r=r.concat(Es(s,n,i,t))),r}}function ya(n,e,t,i){const s=e.get(w());t==null&&s!=null&&(t=Ae(s,w()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=t?t.getImmediateChild(o):null,l=oa(i,o),h=n.operationForChild(o);h&&(r=r.concat(ya(h,a,c,l)))}),s&&(r=r.concat(Es(s,n,i,t))),r}function Ea(n,e){const t=e.query,i=Kt(n,t);return{hashFn:()=>(dd(e)||g.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Ad(n,t._path,i):Rd(n,t._path);{const r=Ru(s,t);return Un(n,t,null,r)}}}}function Kt(n,e){const t=Jn(e);return n.queryToTagMap.get(t)}function Jn(n){return n._path.toString()+"$"+n._queryIdentifier}function Ts(n,e){return n.tagToQueryMap.get(e)}function ws(n){const e=n.indexOf("$");return p(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new S(n.substr(0,e))}}function Cs(n,e,t){const i=n.syncPointTree_.get(e);p(i,"Missing sync point for query tag that we're tracking");const s=Yn(n.pendingWriteTree_,e);return Es(i,t,s,null)}function Pd(n){return n.fold((e,t,i)=>{if(t&&De(t))return[Qn(t)];{let s=[];return t&&(s=fa(t)),B(i,(r,o)=>{s=s.concat(o)}),s}})}function Mt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(wd())(n._repo,n._path):n}function Od(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=Jn(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function Dd(){return Cd++}function Ld(n,e,t){const i=e._path,s=Kt(n,e),r=Ea(n,t),o=n.listenProvider_.startListening(Mt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)p(!De(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,h,u)=>{if(!v(l)&&h&&De(h))return[Qn(h).query];{let d=[];return h&&(d=d.concat(fa(h).map(_=>_.query))),B(u,(_,m)=>{d=d.concat(m)}),d}});for(let l=0;l<c.length;++l){const h=c[l];n.listenProvider_.stopListening(Mt(h),Kt(n,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Ss(t)}node(){return this.node_}}class bs{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=P(this.path_,e);return new bs(this.syncTree_,t)}node(){return vs(this.syncTree_,this.path_)}}const Md=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Fr=function(n,e,t){if(!n||typeof n!="object")return n;if(p(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return xd(n[".sv"],e,t);if(typeof n[".sv"]=="object")return Fd(n[".sv"],e);p(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},xd=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:p(!1,"Unexpected server value: "+n)}},Fd=function(n,e,t){n.hasOwnProperty("increment")||p(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const i=n.increment;typeof i!="number"&&p(!1,"Unexpected increment value: "+i);const s=e.node();if(p(s!==null&&typeof s<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!s.isLeafNode())return i;const o=s.getValue();return typeof o!="number"?i:o+i},va=function(n,e,t,i){return Rs(e,new bs(t,n),i)},Ta=function(n,e,t){return Rs(n,new Ss(e),t)};function Rs(n,e,t){const i=n.getPriority().val(),s=Fr(i,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,a=Fr(o.getValue(),e,t);return a!==o.getValue()||s!==o.getPriority().val()?new U(a,x(s)):n}else{const o=n;return r=o,s!==o.getPriority().val()&&(r=r.updatePriority(new U(s))),o.forEachChild(O,(a,c)=>{const l=Rs(c,e.getImmediateChild(a),t);l!==c&&(r=r.updateImmediateChild(a,l))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hd=/[\[\].#$\/\u0000-\u001F\u007F]/,Bd=/[\[\].#$\u0000-\u001F\u007F]/,Ti=10*1024*1024,ks=function(n){return typeof n=="string"&&n.length!==0&&!Hd.test(n)},ba=function(n){return typeof n=="string"&&n.length!==0&&!Bd.test(n)},Gd=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),ba(n)},qd=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!is(n)||n&&typeof n=="object"&&oe(n,".sv")},$d=function(n,e,t,i){Zn($n(n,"value"),e,t)},Zn=function(n,e,t){const i=t instanceof S?new ah(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Ue(i));if(typeof e=="function")throw new Error(n+"contains a function "+Ue(i)+" with contents = "+e.toString());if(is(e))throw new Error(n+"contains "+e.toString()+" "+Ue(i));if(typeof e=="string"&&e.length>Ti/3&&zn(e)>Ti)throw new Error(n+"contains a string greater than "+Ti+" utf8 bytes "+Ue(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(B(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!ks(o)))throw new Error(n+" contains an invalid key ("+o+") "+Ue(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);ch(i,o),Zn(n,a,i),lh(i)}),s&&r)throw new Error(n+' contains ".value" child '+Ue(i)+" in addition to actual children.")}},zd=function(n,e){let t,i;for(t=0;t<e.length;t++){i=e[t];const r=Gt(i);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!ks(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(oh);let s=null;for(t=0;t<e.length;t++){if(i=e[t],s!==null&&Q(s,i))throw new Error(n+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}},jd=function(n,e,t,i){const s=$n(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(s+" must be an object containing the children to replace.");const r=[];B(e,(o,a)=>{const c=new S(o);if(Zn(s,a,P(t,c)),cs(c)===".priority"&&!qd(a))throw new Error(s+"contains an invalid value for '"+c.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(c)}),zd(s,r)},Ra=function(n,e,t,i){if(!ba(t))throw new Error($n(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Kd=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Ra(n,e,t)},Yd=function(n,e){if(y(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Qd=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!ks(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Gd(t))throw new Error($n(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jd{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function ei(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!ls(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function Aa(n,e,t){ei(n,t),Na(n,i=>ls(i,e))}function J(n,e,t){ei(n,t),Na(n,i=>Q(i,e)||Q(e,i))}function Na(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(Xd(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Xd(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();Pt&&H("event: "+t.toString()),_t(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zd="repo_interrupt",ef=25;class tf{constructor(e,t,i,s){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Jd,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=kn(),this.transactionQueueTree_=new As,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function nf(n,e,t){if(n.stats_=os(n.repoInfo_),n.forceRestClient_||Pu())n.server_=new Nn(n.repoInfo_,(i,s,r,o)=>{Ur(n,i,s,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Vr(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{F(t)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}n.persistentConnection_=new pe(n.repoInfo_,e,(i,s,r,o)=>{Ur(n,i,s,r,o)},i=>{Vr(n,i)},i=>{rf(n,i)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(i=>{n.server_.refreshAuthToken(i)}),n.appCheckProvider_.addTokenChangeListener(i=>{n.server_.refreshAppCheckToken(i.token)}),n.statsReporter_=xu(n.repoInfo_,()=>new Mh(n.stats_,n.server_)),n.infoData_=new kh,n.infoSyncTree_=new xr({startListening:(i,s,r,o)=>{let a=[];const c=n.infoData_.getNode(i._path);return c.isEmpty()||(a=on(n.infoSyncTree_,i._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Ps(n,"connected",!1),n.serverSyncTree_=new xr({startListening:(i,s,r,o)=>(n.server_.listen(i,r,s,(a,c)=>{const l=o(a,c);J(n.eventQueue_,i._path,l)}),[]),stopListening:(i,s)=>{n.server_.unlisten(i,s)}})}function sf(n){const t=n.infoData_.getNode(new S(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function ti(n){return Md({timestamp:sf(n)})}function Ur(n,e,t,i,s){n.dataUpdateCount++;const r=new S(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(s)if(i){const c=Cn(t,l=>x(l));o=Nd(n.serverSyncTree_,r,c,s)}else{const c=x(t);o=ga(n.serverSyncTree_,r,c,s)}else if(i){const c=Cn(t,l=>x(l));o=bd(n.serverSyncTree_,r,c)}else{const c=x(t);o=on(n.serverSyncTree_,r,c)}let a=r;o.length>0&&(a=ut(n,r)),J(n.eventQueue_,a,o)}function Vr(n,e){Ps(n,"connected",e),e===!1&&lf(n)}function rf(n,e){B(e,(t,i)=>{Ps(n,t,i)})}function Ps(n,e,t){const i=new S("/.info/"+e),s=x(t);n.infoData_.updateSnapshot(i,s);const r=on(n.infoSyncTree_,i,s);J(n.eventQueue_,i,r)}function Os(n){return n.nextWriteId_++}function of(n,e,t){const i=kd(n.serverSyncTree_,e);return i!=null?Promise.resolve(i):n.server_.get(e).then(s=>{const r=x(s).withIndex(e._queryParams.getIndex());qi(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=on(n.serverSyncTree_,e._path,r);else{const a=Kt(n.serverSyncTree_,e);o=ga(n.serverSyncTree_,e._path,r,a)}return J(n.eventQueue_,e._path,o),Un(n.serverSyncTree_,e,t,null,!0),r},s=>(cn(n,"get for query "+F(e)+" failed: "+s),Promise.reject(new Error(s))))}function af(n,e,t,i,s){cn(n,"set",{path:e.toString(),value:t,priority:i});const r=ti(n),o=x(t,i),a=vs(n.serverSyncTree_,e),c=Ta(o,a,r),l=Os(n),h=ma(n.serverSyncTree_,e,c,l,!0);ei(n.eventQueue_,h),n.server_.put(e.toString(),o.val(!0),(d,_)=>{const m=d==="ok";m||q("set at "+e+" failed: "+d);const T=Ce(n.serverSyncTree_,l,!m);J(n.eventQueue_,e,T),zi(n,s,d,_)});const u=Ls(n,e);ut(n,u),J(n.eventQueue_,u,[])}function cf(n,e,t,i){cn(n,"update",{path:e.toString(),value:t});let s=!0;const r=ti(n),o={};if(B(t,(a,c)=>{s=!1,o[a]=va(P(e,a),x(c),n.serverSyncTree_,r)}),s)H("update() called with empty data.  Don't do anything."),zi(n,i,"ok",void 0);else{const a=Os(n),c=Sd(n.serverSyncTree_,e,o,a);ei(n.eventQueue_,c),n.server_.merge(e.toString(),t,(l,h)=>{const u=l==="ok";u||q("update at "+e+" failed: "+l);const d=Ce(n.serverSyncTree_,a,!u),_=d.length>0?ut(n,e):e;J(n.eventQueue_,_,d),zi(n,i,l,h)}),B(t,l=>{const h=Ls(n,P(e,l));ut(n,h)}),J(n.eventQueue_,e,[])}}function lf(n){cn(n,"onDisconnectEvents");const e=ti(n),t=kn();Ui(n.onDisconnect_,w(),(s,r)=>{const o=va(s,r,n.serverSyncTree_,e);ta(t,s,o)});let i=[];Ui(t,w(),(s,r)=>{i=i.concat(on(n.serverSyncTree_,s,r));const o=Ls(n,s);ut(n,o)}),n.onDisconnect_=kn(),J(n.eventQueue_,w(),i)}function uf(n,e,t){let i;y(e._path)===".info"?i=qi(n.infoSyncTree_,e,t):i=qi(n.serverSyncTree_,e,t),Aa(n.eventQueue_,e._path,i)}function Wr(n,e,t){let i;y(e._path)===".info"?i=Un(n.infoSyncTree_,e,t):i=Un(n.serverSyncTree_,e,t),Aa(n.eventQueue_,e._path,i)}function hf(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Zd)}function cn(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),H(t,...e)}function zi(n,e,t,i){e&&_t(()=>{if(t==="ok")e(null);else{const s=(t||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function ka(n,e,t){return vs(n.serverSyncTree_,e,t)||g.EMPTY_NODE}function Ds(n,e=n.transactionQueueTree_){if(e||ni(n,e),gt(e)){const t=Oa(n,e);p(t.length>0,"Sending zero length transaction queue"),t.every(s=>s.status===0)&&df(n,an(e),t)}else Ca(e)&&Xn(e,t=>{Ds(n,t)})}function df(n,e,t){const i=t.map(l=>l.currentWriteId),s=ka(n,e,i);let r=s;const o=s.hash();for(let l=0;l<t.length;l++){const h=t[l];p(h.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),h.status=1,h.retryCount++;const u=G(e,h.path);r=r.updateChild(u,h.currentOutputSnapshotRaw)}const a=r.val(!0),c=e;n.server_.put(c.toString(),a,l=>{cn(n,"transaction put response",{path:c.toString(),status:l});let h=[];if(l==="ok"){const u=[];for(let d=0;d<t.length;d++)t[d].status=2,h=h.concat(Ce(n.serverSyncTree_,t[d].currentWriteId)),t[d].onComplete&&u.push(()=>t[d].onComplete(null,!0,t[d].currentOutputSnapshotResolved)),t[d].unwatcher();ni(n,Ns(n.transactionQueueTree_,e)),Ds(n,n.transactionQueueTree_),J(n.eventQueue_,e,h);for(let d=0;d<u.length;d++)_t(u[d])}else{if(l==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{q("transaction at "+c.toString()+" failed: "+l);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=l}ut(n,e)}},o)}function ut(n,e){const t=Pa(n,e),i=an(t),s=Oa(n,t);return ff(n,s,i),i}function ff(n,e,t){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=G(t,c.path);let h=!1,u;if(p(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)h=!0,u=c.abortReason,s=s.concat(Ce(n.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=ef)h=!0,u="maxretry",s=s.concat(Ce(n.serverSyncTree_,c.currentWriteId,!0));else{const d=ka(n,c.path,o);c.currentInputSnapshot=d;const _=e[a].update(d.val());if(_!==void 0){Zn("transaction failed: Data returned ",_,c.path);let m=x(_);typeof _=="object"&&_!=null&&oe(_,".priority")||(m=m.updatePriority(d.getPriority()));const L=c.currentWriteId,Y=ti(n),Z=Ta(m,d,Y);c.currentOutputSnapshotRaw=m,c.currentOutputSnapshotResolved=Z,c.currentWriteId=Os(n),o.splice(o.indexOf(L),1),s=s.concat(ma(n.serverSyncTree_,c.path,Z,c.currentWriteId,c.applyLocally)),s=s.concat(Ce(n.serverSyncTree_,L,!0))}else h=!0,u="nodata",s=s.concat(Ce(n.serverSyncTree_,c.currentWriteId,!0))}J(n.eventQueue_,t,s),s=[],h&&(e[a].status=2,(function(d){setTimeout(d,Math.floor(0))})(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(u),!1,null))))}ni(n,n.transactionQueueTree_);for(let a=0;a<i.length;a++)_t(i[a]);Ds(n,n.transactionQueueTree_)}function Pa(n,e){let t,i=n.transactionQueueTree_;for(t=y(e);t!==null&&gt(i)===void 0;)i=Ns(i,t),e=R(e),t=y(e);return i}function Oa(n,e){const t=[];return Da(n,e,t),t.sort((i,s)=>i.order-s.order),t}function Da(n,e,t){const i=gt(e);if(i)for(let s=0;s<i.length;s++)t.push(i[s]);Xn(e,s=>{Da(n,s,t)})}function ni(n,e){const t=gt(e);if(t){let i=0;for(let s=0;s<t.length;s++)t[s].status!==2&&(t[i]=t[s],i++);t.length=i,wa(e,t.length>0?t:void 0)}Xn(e,i=>{ni(n,i)})}function Ls(n,e){const t=an(Pa(n,e)),i=Ns(n.transactionQueueTree_,e);return Vd(i,s=>{wi(n,s)}),wi(n,i),Sa(i,s=>{wi(n,s)}),t}function wi(n,e){const t=gt(e);if(t){const i=[];let s=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(p(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(p(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),s=s.concat(Ce(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&i.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?wa(e,void 0):t.length=r+1,J(n.eventQueue_,an(e),s);for(let o=0;o<i.length;o++)_t(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ms{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return v(this._path)?null:cs(this._path)}get ref(){return new Ee(this._repo,this._path)}get _queryIdentifier(){const e=br(this._queryParams),t=ss(e);return t==="{}"?"default":t}get _queryObject(){return br(this._queryParams)}isEqual(e){if(e=I(e),!(e instanceof Ms))return!1;const t=this._repo===e._repo,i=ls(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+rh(this._path)}}class Ee extends Ms{constructor(e,t){super(e,t,new fs,!1)}get parent(){const e=jo(this._path);return e===null?null:new Ee(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Yt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new S(e),i=ji(this.ref,e);return new Yt(this._node.getChild(t),i,O)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Yt(s,ji(this.ref,i),O)))}hasChild(e){const t=new S(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function ag(n,e){return n=I(n),n._checkNotDeleted("ref"),e!==void 0?ji(n._root,e):n._root}function ji(n,e){return n=I(n),y(n._path)===null?Kd("child","path",e):Ra("child","path",e),new Ee(n._repo,P(n._path,e))}function cg(n,e){n=I(n),Yd("set",n._path),$d("set",e,n._path);const t=new en;return af(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function lg(n,e){jd("update",e,n._path);const t=new en;return cf(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function ug(n){n=I(n);const e=new La(()=>{}),t=new ii(e);return of(n._repo,n,t).then(i=>new Yt(i,new Ee(n._repo,n._path),n._queryParams.getIndex()))}class ii{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new gf("value",this,new Yt(e.snapshotNode,new Ee(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new If(this,e,t):null}matches(e){return e instanceof ii?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function yf(n,e,t,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const c=t,l=(h,u)=>{Wr(n._repo,n,a),c(h,u)};l.userCallback=t.userCallback,l.context=t.context,t=l}const o=new La(t,r||void 0),a=new ii(o);return uf(n._repo,n,a),()=>Wr(n._repo,n,a)}function hg(n,e,t,i){return yf(n,"value",e,t,i)}gd(Ee);Td(Ee);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ef="FIREBASE_DATABASE_EMULATOR_HOST",Ki={};let vf=!1;function Tf(n,e,t,i){const s=e.lastIndexOf(":"),r=e.substring(0,s),o=ft(r);n.repoInfo_=new Uo(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),i&&(n.authTokenProvider_=i)}function wf(n,e,t,i,s){let r=i||n.options.databaseURL;r===void 0&&(n.options.projectId||ge("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),H("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Hr(r,s),a=o.repoInfo,c;typeof process<"u"&&cr&&(c=cr[Ef]),c?(r=`http://${c}?ns=${a.namespace}`,o=Hr(r,s),a=o.repoInfo):o.repoInfo.secure;const l=new Du(n.name,n.options,e);Qd("Invalid Firebase Database URL",o),v(o.path)||ge("Database URL must point to the root of a Firebase Database (not including a child path).");const h=Sf(a,n,l,new Ou(n,t));return new bf(h,n)}function Cf(n,e){const t=Ki[e];(!t||t[n.key]!==n)&&ge(`Database ${e}(${n.repoInfo_}) has already been deleted.`),hf(n),delete t[n.key]}function Sf(n,e,t,i){let s=Ki[e.name];s||(s={},Ki[e.name]=s);let r=s[n.toURLString()];return r&&ge("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new tf(n,vf,t,i),s[n.toURLString()]=r,r}class bf{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(nf(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ee(this._repo,w())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Cf(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&ge("Cannot call "+e+" on a deleted database.")}}function dg(n=vo(),e){const t=ns(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const i=Qc("database");i&&Rf(t,...i)}return t}function Rf(n,e,t,i={}){n=I(n),n._checkNotDeleted("useEmulator");const s=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(s===n._repoInternal.repoInfo_.host&&Be(i,r.repoInfo_.emulatorOptions))return;ge("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&ge('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new gn(gn.OWNER);else if(i.mockUserToken){const a=typeof i.mockUserToken=="string"?i.mockUserToken:Jc(i.mockUserToken,n.app.options.projectId);o=new gn(a)}ft(e)&&(go(e),Io("Database",!0)),Tf(r,s,i,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Af(n){mu(pt),rt(new Ge("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return wf(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),be(lr,ur,n),be(lr,ur,"esm2020")}pe.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};pe.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Af();/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qt(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function Us(){return Br()==="http:"||Br()==="https:"}function Br(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uf(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Us()||tl()||"connection"in navigator)?navigator.onLine:!0}function Vf(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ln{constructor(e,t){this.shortDelay=e,this.longDelay=t,Ie(t>e,"Short delay should be less than long delay!"),this.isMobile=es()||yo()}get(){return Uf()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hf=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Bf=new ln(3e4,6e4);function A(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function N(n,e,t,i,s={}){return Va(n,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=je({key:n.config.apiKey,...o}).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const l={method:e,headers:c,...r};return el()||(l.referrerPolicy="no-referrer"),n.emulatorConfig&&ft(n.emulatorConfig.host)&&(l.credentials="include"),Ua.fetch()(await Wa(n,n.config.apiHost,t,a),l)})}async function Va(n,e,t){n._canInitEmulator=!1;const i={...Wf,...e};try{const s=new qf(n),r=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Nt(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw Nt(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw Nt(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw Nt(n,"user-disabled",o);const h=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw xs(n,h,l);K(n,h)}}catch(s){if(s instanceof Le)throw s;K(n,"network-request-failed",{message:String(s)})}}async function ve(n,e,t,i,s={}){const r=await N(n,e,t,i,s);return"mfaPendingCredential"in r&&K(n,"multi-factor-auth-required",{_serverResponse:r}),r}async function Wa(n,e,t,i){const s=`${e}${t}?${i}`,r=n,o=r.config.emulator?Vs(n.config,s):`${n.config.apiScheme}://${s}`;return Hf.includes(t)&&(await r._persistenceManagerAvailable,r._getPersistenceType()==="COOKIE")?r._getPersistence()._getFinalTarget(o).toString():o}function Gf(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class qf{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i($(this.auth,"network-request-failed")),Bf.get())})}}function Nt(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const s=$(n,e,i);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $f(n){return(await N(n,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}async function Ba(n,e){return N(n,"GET","/v2/recaptchaConfig",A(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xf(n,e){const t=await Va(n,{},async()=>{const i=je({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=n.config,o=await Wa(n,s,"/v1/token",`key=${r}`),a=await n._getAdditionalHeaders();a["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:a,body:i};return n.emulatorConfig&&ft(n.emulatorConfig.host)&&(c.credentials="include"),Ua.fetch()(o,c)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Zf(n,e){return N(n,"POST","/v2/accounts:revokeToken",A(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr=new Map;function de(n){Ie(n instanceof Function,"Expected a class definition");let e=zr.get(n);return e?(Ie(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,zr.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class za{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}za.type="NONE";const Qi=za;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jr(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Qa(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(ja(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Xa(e))return"Blackberry";if(Za(e))return"Webos";if(Ka(e))return"Safari";if((e.includes("chrome/")||Ya(e))&&!e.includes("edge/"))return"Chrome";if(Ja(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function ja(n=z()){return/firefox\//i.test(n)}function Ka(n=z()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ya(n=z()){return/crios\//i.test(n)}function Qa(n=z()){return/iemobile/i.test(n)}function Ja(n=z()){return/android/i.test(n)}function Xa(n=z()){return/blackberry/i.test(n)}function Za(n=z()){return/webos/i.test(n)}function Ws(n=z()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function ep(n=z()){var e;return Ws(n)&&!!((e=window.navigator)!=null&&e.standalone)}function tp(){return nl()&&document.documentMode===10}function ec(n=z()){return Ws(n)||Ja(n)||Za(n)||Xa(n)||/windows phone/i.test(n)||Qa(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tc(n,e=[]){let t;switch(n){case"Browser":t=jr(z());break;case"Worker":t=`${jr(z())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${pt}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let un={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function ap(n){un=n}function Hs(n){return un.loadJS(n)}function cp(){return un.recaptchaV2Script}function lp(){return un.recaptchaEnterpriseScript}function up(){return un.gapiScript}function nc(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rc(n,e){const t=ns(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),r=t.getOptions();if(Be(r,e??{}))return s;K(s,"already-initialized")}return t.initialize({options:e})}function yp(n,e){const t=(e==null?void 0:e.persistence)||[],i=(Array.isArray(t)?t:[t]).map(de);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function oc(n,e,t){const i=D(n);f(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!!(t!=null&&t.disableWarnings),r=ac(e),{host:o,port:a}=Ep(e),c=a===null?"":`:${a}`,l={url:`${r}//${o}${c}/`},h=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!i._canInitEmulator){f(i.config.emulator&&i.emulatorConfig,i,"emulator-config-failed"),f(Be(l,i.config.emulator)&&Be(h,i.emulatorConfig),i,"emulator-config-failed");return}i.config.emulator=l,i.emulatorConfig=h,i.settings.appVerificationDisabledForTesting=!0,ft(o)?(go(`${r}//${o}${c}`),Io("Auth",!0)):s||vp()}function ac(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Ep(n){const e=ac(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:Yr(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:Yr(o)}}}function Yr(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function vp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cc(n,e){return N(n,"POST","/v1/accounts:resetPassword",A(n,e))}async function Tp(n,e){return N(n,"POST","/v1/accounts:update",e)}async function wp(n,e){return N(n,"POST","/v1/accounts:signUp",e)}async function Cp(n,e){return N(n,"POST","/v1/accounts:update",A(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lc(n,e){return ve(n,"POST","/v1/accounts:signUp",A(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class X{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,i,s=!1){const r=await ne._fromIdTokenResponse(e,i,s),o=Jr(i);return new X({user:r,providerId:o,_tokenResponse:i,operationType:t})}static async _forOperation(e,t,i){await e._updateTokensIfNecessary(i,!0);const s=Jr(i);return new X({user:e,providerId:s,_tokenResponse:i,operationType:t})}}function Jr(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gp(n,e){const t=I(n);await oi(!0,t,e);const{providerUserInfo:i}=await jf(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),s=hc(i||[]);return t.providerData=t.providerData.filter(r=>s.has(r.providerId)),s.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function Bs(n,e,t=!1){const i=await ye(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return X._forOperation(n,"link",i)}async function oi(n,e,t){await Jt(e);const i=hc(e.providerData),s=n===!1?"provider-already-linked":"no-such-provider";f(i.has(t)===n,e.auth,s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fc(n,e,t=!1){if(k(n.app))return Promise.reject(W(n));const i="signIn",s=await uc(n,i,e),r=await X._fromIdTokenResponse(n,i,s);return t||await n._updateCurrentUser(r.user),r}async function ai(n,e){return fc(D(n),e)}async function pc(n,e){const t=I(n);return await oi(!1,t,e.providerId),Bs(t,e)}async function _c(n,e){return dc(I(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $s(n){const e=D(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function zp(n,e,t){const i=D(n),s={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&ci(i,s,t),await Ne(i,s,"getOobCode",Rp,"EMAIL_PASSWORD_PROVIDER")}async function jp(n,e,t){await cc(I(n),{oobCode:e,newPassword:t}).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&$s(n),i})}async function Kp(n,e){await Cp(I(n),{oobCode:e})}async function mc(n,e){const t=I(n),i=await cc(t,{oobCode:e}),s=i.requestType;switch(f(s,t,"internal-error"),s){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":f(i.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":f(i.mfaInfo,t,"internal-error");default:f(i.email,t,"internal-error")}let r=null;return i.mfaInfo&&(r=hn._fromServerResponse(D(t),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:r},operation:s}}async function Yp(n,e){const{data:t}=await mc(I(n),e);return t.email}async function Qp(n,e,t){if(k(n.app))return Promise.reject(W(n));const i=D(n),o=await Ne(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",lc,"EMAIL_PASSWORD_PROVIDER").catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&$s(n),c}),a=await X._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function Jp(n,e,t){return k(n.app)?Promise.reject(W(n)):ai(I(n),Me.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&$s(n),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l_(n){var s,r;if(!n)return null;const{providerId:e}=n,t=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},i=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!e&&(n!=null&&n.idToken)){const o=(r=(s=si(n.idToken))==null?void 0:s.firebase)==null?void 0:r.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new it(i,a)}}if(!e)return null;switch(e){case"facebook.com":return new u_(i,t);case"github.com":return new h_(i,t);case"google.com":return new d_(i,t);case"twitter.com":return new f_(i,t,n.screenName||null);case"custom":case"anonymous":return new it(i,null);default:return new it(i,e,t)}}class it{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class Ic extends it{constructor(e,t,i,s){super(e,t,i),this.username=s}}class u_ extends it{constructor(e,t){super(e,"facebook.com",t)}}class h_ extends Ic{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class d_ extends it{constructor(e,t){super(e,"google.com",t)}}class f_ extends Ic{constructor(e,t,i){super(e,"twitter.com",t,i)}}function p_(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:l_(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function __(n,e){return I(n).setPersistence(e)}function m_(n){return sc(n)}async function g_(n,e){return D(n).validatePassword(e)}function yc(n,e,t,i){return I(n).onIdTokenChanged(e,t,i)}function Ec(n,e,t){return I(n).beforeAuthStateChanged(e,t)}function I_(n,e,t,i){return I(n).onAuthStateChanged(e,t,i)}function y_(n){I(n).useDeviceLanguage()}function E_(n,e){return I(n).updateCurrentUser(e)}function v_(n){return I(n).signOut()}function T_(n,e){return D(n).revokeAccessToken(e)}async function w_(n){return I(n).delete()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vc{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Gn,"1"),this.storage.removeItem(Gn),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O_=1e3;function bi(n){var i;const e=n.replace(/[\\^$.*+?()[\]{}|]/g,"\\$&"),t=RegExp(`${e}=([^;]+)`);return((i=document.cookie.match(t))==null?void 0:i[1])??null}function Ri(n){return`${window.location.protocol==="http:"?"__dev_":"__HOST-"}FIREBASE_${n.split(":")[3]}`}class Cc{constructor(){this.type="COOKIE",this.listenerUnsubscribes=new Map}_getFinalTarget(e){if(typeof window===void 0)return e;const t=new URL(`${window.location.origin}/__cookies__`);return t.searchParams.set("finalTarget",e),t}async _isAvailable(){return typeof isSecureContext=="boolean"&&!isSecureContext||typeof navigator>"u"||typeof document>"u"?!1:navigator.cookieEnabled??!0}async _set(e,t){}async _get(e){if(!this._isAvailable())return null;const t=Ri(e);if(window.cookieStore){const i=await window.cookieStore.get(t);return i==null?void 0:i.value}return bi(t)}async _remove(e){if(!this._isAvailable()||!await this._get(e))return;const i=Ri(e);document.cookie=`${i}=;Max-Age=34560000;Partitioned;Secure;SameSite=Strict;Path=/;Priority=High`,await fetch("/__cookies__",{method:"DELETE"}).catch(()=>{})}_addListener(e,t){if(!this._isAvailable())return;const i=Ri(e);if(window.cookieStore){const a=(l=>{const h=l.changed.find(d=>d.name===i);h&&t(h.value),l.deleted.find(d=>d.name===i)&&t(null)}),c=()=>window.cookieStore.removeEventListener("change",a);return this.listenerUnsubscribes.set(t,c),window.cookieStore.addEventListener("change",a)}let s=bi(i);const r=setInterval(()=>{const a=bi(i);a!==s&&(t(a),s=a)},O_),o=()=>clearInterval(r);this.listenerUnsubscribes.set(t,o)}_removeListener(e,t){const i=this.listenerUnsubscribes.get(t);i&&(i(),this.listenerUnsubscribes.delete(t))}}Cc.type="COOKIE";const D_=Cc;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sc extends vc{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Sc.type="SESSION";const Ks=Sc;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function to(n,e){return N(n,"POST","/v2/accounts/mfaSignIn:start",A(n,e))}function $_(n,e){return N(n,"POST","/v2/accounts/mfaSignIn:finalize",A(n,e))}function z_(n,e){return N(n,"POST","/v2/accounts/mfaSignIn:finalize",A(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ai=nc("rcb"),j_=new ln(3e4,6e4);class K_{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!((e=M().grecaptcha)!=null&&e.render)}load(e,t=""){return f(Y_(t),e,"argument-error"),this.shouldResolveImmediately(t)&&Gr(M().grecaptcha)?Promise.resolve(M().grecaptcha):new Promise((i,s)=>{const r=M().setTimeout(()=>{s($(e,"network-request-failed"))},j_.get());M()[Ai]=()=>{M().clearTimeout(r),delete M()[Ai];const a=M().grecaptcha;if(!a||!Gr(a)){s($(e,"internal-error"));return}const c=a.render;a.render=(l,h)=>{const u=c(l,h);return this.counter++,u},this.hostLanguage=t,i(a)};const o=`${cp()}?${je({onload:Ai,render:"explicit",hl:t})}`;Hs(o).catch(()=>{clearTimeout(r),s($(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!((t=M().grecaptcha)!=null&&t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function Y_(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class Q_{async load(e){return new fp(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kc{constructor(e,t,i,s,r=!1){this.auth=e,this.resolver=i,this.user=s,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:s,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:i,tenantId:r||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return sm;case"linkViaPopup":case"linkViaRedirect":return om;case"reauthViaPopup":case"reauthViaRedirect":return rm;default:K(this.auth,"internal-error")}}resolve(e){Ie(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Ie(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hm="pendingRedirect",En=new Map;class dm extends kc{constructor(e,t,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,i),this.eventId=null}async execute(){let e=En.get(this.auth._key());if(!e){try{const i=await fm(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(t){e=()=>Promise.reject(t)}En.set(this.auth._key(),e)}return this.bypassAuthState||En.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function fm(n,e){const t=Oc(e),i=Pc(n);if(!await i._isAvailable())return!1;const s=await i._get(t)==="true";return await i._remove(t),s}async function Xs(n,e){return Pc(n)._set(Oc(e),"true")}function pm(n,e){En.set(n._key(),e)}function Pc(n){return de(n._redirectPersistence)}function Oc(n){return yn(hm,n.config.apiKey,n.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _m(n,e,t){return mm(n,e,t)}async function mm(n,e,t){if(k(n.app))return Promise.reject(W(n));const i=D(n);It(n,e,Te),await i._initializationPromise;const s=Qe(i,t);return await Xs(s,i),s._openRedirect(i,e,"signInViaRedirect")}function gm(n,e,t){return Im(n,e,t)}async function Im(n,e,t){const i=I(n);if(It(i.auth,e,Te),k(i.auth.app))return Promise.reject(W(i.auth));await i.auth._initializationPromise;const s=Qe(i.auth,t);await Xs(s,i.auth);const r=await Lc(i);return s._openRedirect(i.auth,e,"reauthViaRedirect",r)}function ym(n,e,t){return Em(n,e,t)}async function Em(n,e,t){const i=I(n);It(i.auth,e,Te),await i.auth._initializationPromise;const s=Qe(i.auth,t);await oi(!1,i,e.providerId),await Xs(s,i.auth);const r=await Lc(i);return s._openRedirect(i.auth,e,"linkViaRedirect",r)}async function vm(n,e){return await D(n)._initializationPromise,Dc(n,e,!1)}async function Dc(n,e,t=!1){if(k(n.app))return Promise.reject(W(n));const i=D(n),s=Qe(i,e),o=await new dm(i,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Lc(n){const e=ui(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tm=600*1e3;class wm{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!Cm(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!Mc(e)){const s=((i=e.error.code)==null?void 0:i.split("auth/")[1])||"internal-error";t.onError($(this.auth,s))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=Tm&&this.cachedEventUids.clear(),this.cachedEventUids.has(no(e))}saveEventToCache(e){this.cachedEventUids.add(no(e)),this.lastProcessedEventTime=Date.now()}}function no(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function Mc({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function Cm(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Mc(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const km=new ln(3e4,6e4);function io(){const n=M().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Pm(n){return new Promise((e,t)=>{var s,r,o;function i(){io(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{io(),t($(n,"network-request-failed"))},timeout:km.get()})}if((r=(s=M().gapi)==null?void 0:s.iframes)!=null&&r.Iframe)e(gapi.iframes.getContext());else if((o=M().gapi)!=null&&o.load)i();else{const a=nc("iframefcb");return M()[a]=()=>{gapi.load?i():t($(n,"network-request-failed"))},Hs(`${up()}?onload=${a}`).catch(c=>t(c))}}).catch(e=>{throw vn=null,e})}let vn=null;function Om(n){return vn=vn||Pm(n),vn}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wm={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Hm=500,Bm=600,Gm="_blank",qm="http://localhost";class so{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function $m(n,e,t,i=Hm,s=Bm){const r=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c={...Wm,width:i.toString(),height:s.toString(),top:r,left:o},l=z().toLowerCase();t&&(a=Ya(l)?Gm:t),ja(l)&&(e=e||qm,c.scrollbars="yes");const h=Object.entries(c).reduce((d,[_,m])=>`${d}${_}=${m},`,"");if(ep(l)&&a!=="_self")return zm(e||"",a),new so(null);const u=window.open(e||"",a,h);f(u,n,"popup-blocked");try{u.focus()}catch{}return new so(u)}function zm(n,e){const t=document.createElement("a");t.href=n,t.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki="webStorageSupport";class Jm{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ks,this._completeRedirectFn=Dc,this._overrideRedirectResult=pm}async _openPopup(e,t,i,s){var o;Ie((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const r=await ro(e,t,i,Qt(),s);return $m(e,r,ui())}async _openRedirect(e,t,i,s){await this._originValidation(e);const r=await ro(e,t,i,Qt(),s);return x_(r),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:r}=this.eventManagers[t];return s?Promise.resolve(s):(Ie(r,"If manager is not set, promise should be"),r)}const i=this.initAndGetManager(e);return this.eventManagers[t]={promise:i},i.catch(()=>{delete this.eventManagers[t]}),i}async initAndGetManager(e){const t=await Vm(e),i=new wm(e);return t.register("authEvent",s=>(f(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:i.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:i},this.iframes[e._key()]=t,i}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ki,{type:ki},s=>{var o;const r=(o=s==null?void 0:s[0])==null?void 0:o[ki];r!==void 0&&t(!!r),K(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Am(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ec()||Ka()||Ws()}}const xc=Jm;class Fc{constructor(e){this.factorId=e}_process(e,t,i){switch(t.type){case"enroll":return this._finalizeEnroll(e,t.credential,i);case"signin":return this._finalizeSignIn(e,t.credential);default:return se("unexpected MultiFactorSessionType")}}}class Zs extends Fc{constructor(e){super("phone"),this.credential=e}static _fromCredential(e){return new Zs(e)}_finalizeEnroll(e,t,i){return S_(e,{idToken:t,displayName:i,phoneVerificationInfo:this.credential._makeVerificationRequest()})}_finalizeSignIn(e,t){return $_(e,{mfaPendingCredential:t,phoneVerificationInfo:this.credential._makeVerificationRequest()})}}class Uc{constructor(){}static assertion(e){return Zs._fromCredential(e)}}Uc.FACTOR_ID="phone";class Vc{static assertionForEnrollment(e,t){return Zt._fromSecret(e,t)}static assertionForSignIn(e,t){return Zt._fromEnrollmentId(e,t)}static async generateSecret(e){var s;const t=e;f(typeof((s=t.user)==null?void 0:s.auth)<"u","internal-error");const i=await b_(t.user.auth,{idToken:t.credential,totpEnrollmentInfo:{}});return fi._fromStartTotpMfaEnrollmentResponse(i,t.user.auth)}}Vc.FACTOR_ID="totp";class Zt extends Fc{constructor(e,t,i){super("totp"),this.otp=e,this.enrollmentId=t,this.secret=i}static _fromSecret(e,t){return new Zt(t,void 0,e)}static _fromEnrollmentId(e,t){return new Zt(t,e)}async _finalizeEnroll(e,t,i){return f(typeof this.secret<"u",e,"argument-error"),R_(e,{idToken:t,displayName:i,totpVerificationInfo:this.secret._makeTotpVerificationInfo(this.otp)})}async _finalizeSignIn(e,t){f(this.enrollmentId!==void 0&&this.otp!==void 0,e,"argument-error");const i={verificationCode:this.otp};return z_(e,{mfaPendingCredential:t,mfaEnrollmentId:this.enrollmentId,totpVerificationInfo:i})}}class fi{constructor(e,t,i,s,r,o,a){this.sessionInfo=o,this.auth=a,this.secretKey=e,this.hashingAlgorithm=t,this.codeLength=i,this.codeIntervalSeconds=s,this.enrollmentCompletionDeadline=r}static _fromStartTotpMfaEnrollmentResponse(e,t){return new fi(e.totpSessionInfo.sharedSecretKey,e.totpSessionInfo.hashingAlgorithm,e.totpSessionInfo.verificationCodeLength,e.totpSessionInfo.periodSec,new Date(e.totpSessionInfo.finalizeEnrollmentTime).toUTCString(),e.totpSessionInfo.sessionInfo,t)}_makeTotpVerificationInfo(e){return{sessionInfo:this.sessionInfo,verificationCode:e}}generateQrCodeUrl(e,t){var s;let i=!1;return(mn(e)||mn(t))&&(i=!0),i&&(mn(e)&&(e=((s=this.auth.currentUser)==null?void 0:s.email)||"unknownuser"),mn(t)&&(t=this.auth.name)),`otpauth://totp/${t}:${e}?secret=${this.secretKey}&issuer=${t}&algorithm=${this.hashingAlgorithm}&digits=${this.codeLength}`}}function mn(n){return typeof n>"u"||(n==null?void 0:n.length)===0}var oo="@firebase/auth",ao="1.12.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tg=300,ng=mo("authIdTokenMaxAge")||tg;let co=null;const ig=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>ng)return;const s=t==null?void 0:t.token;co!==s&&(co=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function sg(n=vo()){const e=ns(n,"auth");if(e.isInitialized())return e.getImmediate();const t=rc(n,{popupRedirectResolver:xc,persistence:[Nc,wc,Ks]}),i=mo("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const r=new URL(i,location.origin);if(location.origin===r.origin){const o=ig(r.toString());Ec(t,o,()=>o(t.currentUser)),yc(t,a=>o(a))}}const s=po("auth");return s&&oc(t,`http://${s}`),t}function rg(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}ap({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=s=>{const r=$("internal-error");r.customData=s,t(r)},i.type="text/javascript",i.charset="UTF-8",rg().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});eg("Browser");const fg=Object.freeze(Object.defineProperty({__proto__:null,ActionCodeOperation:Df,ActionCodeURL:Et,AuthCredential:yt,AuthErrorCodes:xf,EmailAuthCredential:ht,EmailAuthProvider:Me,FacebookAuthProvider:ae,FactorId:Nf,GithubAuthProvider:le,GoogleAuthProvider:ce,OAuthCredential:re,OAuthProvider:Ut,OperationType:Of,PhoneAuthCredential:ke,PhoneAuthProvider:He,PhoneMultiFactorGenerator:Uc,ProviderId:kf,RecaptchaVerifier:X_,SAMLAuthProvider:Hn,SignInMethod:Pf,TotpMultiFactorGenerator:Vc,TotpSecret:fi,TwitterAuthProvider:ue,applyActionCode:Kp,beforeAuthStateChanged:Ec,browserCookiePersistence:D_,browserLocalPersistence:wc,browserPopupRedirectResolver:xc,browserSessionPersistence:Ks,checkActionCode:mc,confirmPasswordReset:jp,connectAuthEmulator:oc,createUserWithEmailAndPassword:Qp,debugErrorMap:Mf,deleteUser:w_,fetchSignInMethodsForEmail:n_,getAdditionalUserInfo:p_,getAuth:sg,getIdToken:Kf,getIdTokenResult:Ga,getMultiFactorResolver:C_,getRedirectResult:vm,inMemoryPersistence:Qi,indexedDBLocalPersistence:Nc,initializeAuth:rc,initializeRecaptchaConfig:m_,isSignInWithEmailLink:Zp,linkWithCredential:pc,linkWithPhoneNumber:tm,linkWithPopup:um,linkWithRedirect:ym,multiFactor:N_,onAuthStateChanged:I_,onIdTokenChanged:yc,parseActionCodeURL:Vp,prodErrorMap:xa,reauthenticateWithCredential:_c,reauthenticateWithPhoneNumber:nm,reauthenticateWithPopup:lm,reauthenticateWithRedirect:gm,reload:qa,revokeAccessToken:T_,sendEmailVerification:i_,sendPasswordResetEmail:zp,sendSignInLinkToEmail:Xp,setPersistence:__,signInAnonymously:Bp,signInWithCredential:ai,signInWithCustomToken:$p,signInWithEmailAndPassword:Jp,signInWithEmailLink:e_,signInWithPhoneNumber:em,signInWithPopup:cm,signInWithRedirect:_m,signOut:v_,unlink:Gp,updateCurrentUser:E_,updateEmail:a_,updatePassword:c_,updatePhoneNumber:im,updateProfile:o_,useDeviceLanguage:y_,validatePassword:g_,verifyBeforeUpdateEmail:s_,verifyPasswordResetCode:Yp},Symbol.toStringTag,{value:"Module"}));export{ce as G,sg as a,ug as b,I_ as c,vm as d,cg as e,v_ as f,dg as g,Qp as h,iu as i,Jp as j,fg as k,hg as o,ag as r,Bp as s,lg as u};
